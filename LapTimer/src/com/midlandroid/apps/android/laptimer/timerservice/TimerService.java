...
public class TimerService extends Service {
	...
	private void _getPrefs() {
		...
		// Should a power manager wake lock be used to prevent screen from 
		// shutting off and timing out.
		useWakeLock = prefs.getBoolean(
				res.getString(R.string.pref_use_wakelock_key), false);
	...
	/**
	 * If use wakelock is enabled get the power manager
	 * and set the wakelock state. 
	 */
	...
	/**
	 * Release the wakelock state if it was originally setup.
	 */
